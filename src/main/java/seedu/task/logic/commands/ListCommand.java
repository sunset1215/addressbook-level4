...
public class ListCommand extends Command {
    ...
    public static final String OPTION_LIST_DEFAULT = "";
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            ...
            + "Example: " + COMMAND_WORD + " or " 
                        ...
                        + COMMAND_WORD + " " + OPTION_LIST_COMPLETE;
    ...
    public static final String MESSAGE_LIST_DEFAULT_SUCCESS = "Listed pending tasks!";
    ...
    public CommandResult execute() {
        ...
        case OPTION_LIST_DEFAULT:
            model.updateFilteredListByStatus(Status.STATUS_PENDING);
            return new CommandResult(MESSAGE_LIST_DEFAULT_SUCCESS);
